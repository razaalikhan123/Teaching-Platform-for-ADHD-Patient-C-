    ...
    public partial class Form2 : Form
    {
        ...
        private void CheckPictures(PictureBox A, PictureBox B)
        {
            ...
            if (pictures.All(o => o.Tag == pictures[0].Tag))
            {
                ...
                using (SqlCommand command = new SqlCommand("SELECT score2 FROM StDetais WHERE StudentEmail = '" + lbleid.Text + "'", con))
                {
                    ...
                    if (reader.HasRows)
                    {
                        ...
                        string result = reader["score2"].ToString();
                        ...
                        con.Open();
                        SqlCommand cmd;
                        cmd = new SqlCommand("UPDATE StDetails SET score2 = '" + intValue + "' WHERE StudentEmail = '" + lbleid.Text + "'", con);
                        cmd.ExecuteNonQuery();
