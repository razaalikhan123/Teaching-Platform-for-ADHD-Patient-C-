...
namespace SE_Project
{
    ...
    public partial class mq1 : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("UPDATE StDetails SET mq1 = '" + marks + "' WHERE StudentEmail = '" + lbleid.Text + "'", con);
            cmd.ExecuteNonQuery();
        ...
        private void mq1_Load(object sender, EventArgs e)
        {
